...
#POSITIVE_THRESHOLD = 3750.0
POSITIVE_THRESHOLD = 6000

# File to save and load face recognizer model.
FACIAL_FOLDER = '/home/pi/meroir/facial/'
TRAINING_FILE = FACIAL_FOLDER + 'training.xml'

# Directories which contain the positive and negative training image data.
POSITIVE_DIR = FACIAL_FOLDER + '/training/positive'
NEGATIVE_DIR = FACIAL_FOLDER + '/training/negative'
...
HAAR_FACES         = FACIAL_FOLDER + 'haarcascade_frontalface_alt.xml'
HAAR_SCALE_FACTOR  = 1.3
HAAR_MIN_NEIGHBORS = 4
HAAR_MIN_SIZE      = (30, 30)

# Filename to use when saving the most recently captured image for debugging.
DEBUG_IMAGE = FACIAL_FOLDER + 'capture.pgm'
